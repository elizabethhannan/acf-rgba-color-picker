...
class acf_field_rgba_color_picker extends acf_field {
	...
	*/
	...
	function __construct() {
		...
		*  var message = acf._e('rgba_color_picker', 'error');
		*/
		
		$this->l10n = array(
			'error'	=> __('Error! Please enter a higher value', 'acf-rgba_color_picker'),
		);
	...
	function render_field_settings( $field ) {
		...
		*/
		...
		acf_render_field_setting( $field, array(
			'label'			=> __('Font Size','acf-rgba_color_picker'),
			'instructions'	=> __('Customise the input font size','acf-rgba_color_picker'),
			'type'			=> 'number',
			'name'			=> 'font_size',
			'prepend'		=> 'px',
		));
	...
	*/
	...
	function validate_value( $valid, $value, $field, $input ){
		...
		if( $value < $field['custom_minimum_setting'] )
		{
			$valid = __('The value is too little!','acf-rgba_color_picker'),
		}
